  ...
  skillCategories: SkillCategory[] = [
    {
      ...
      icon: 'fa-code',
      skills: [
        { name: 'ITEMS.CSHARP', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.JAVA', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.PYTHON', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.JAVASCRIPT', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.TYPESCRIPT', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.PHP', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.KOTLIN', level: 'LEVELS.INTERMEDIATE' },
        ...
        { name: 'ITEMS.C', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.C++', level: 'LEVELS.INTERMEDIATE' },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'ITEMS.JAVASCRIPT', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.TYPESCRIPT', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.REACTIVEFORMS', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.BOOTSTRAP', level: 'LEVELS.EXPERT' },
        { name: 'ITEMS.RESPONSIVE_DESIGN', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.JQUERY', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.AJAX', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.DOM_MANIPULATION', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.API_INTEGRATION', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.ANGULAR', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.MATERIAL_DESIGN', level: 'LEVELS.INTERMEDIATE' }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: 'ITEMS.JWT', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.LOGGING', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.DATAVALIDATION', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.NODEJS', level: 'LEVELS.INTERMEDIATE' },
      ]
    },
    {
      ...
      icon: 'fa-tools',
      skills: [
        { name: 'ITEMS.GIT', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.GITHUB', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.GITLAB', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.GIT_FLOW', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.DOCKER', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.DOCKER_COMPOSE', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.IIS', level: 'LEVELS.BEGINNER' },
        { name: 'ITEMS.LINUX', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.WINDOWS', level: 'LEVELS.EXPERT' },
        { name: 'ITEMS.BASH_SCRIPTING', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.POWERSHELL', level: 'LEVELS.BEGINNER' },
        { name: 'ITEMS.VERSIONING', level: 'LEVELS.ADVANCED' },
        ...
        { name: 'ITEMS.ANDROID_STUDIO', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.SSMS', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.FIGMA', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.JIRA', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.TRELLO', level: 'LEVELS.ADVANCED' },
        { name: 'ITEMS.POSTMAN', level: 'LEVELS.BEGINNER' },
        { name: 'ITEMS.N8N', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.LM_STUDIO', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.HUGGINGFACE', level: 'LEVELS.INTERMEDIATE' }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: 'ITEMS.TRIGGTERS', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.JSON_DATA_HANDLING', level: 'LEVELS.INTERMEDIATE' },
        { name: 'ITEMS.CONNECTIONS_POOLING', level: 'LEVELS.ADVANCED' }
      ]
    },
    {
